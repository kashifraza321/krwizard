...
export class OportuniteComponent implements OnInit {
  ...
  gamestart: boolean;
  gamewinner: boolean;
  setWinner(edited): void {
    //show box msg
    this.gamewinner = edited;
  }
  setStart(edited): void {
    //show box msg
    this.gamestart = edited;
  }
  setGameOver(edited): void {
    //show box msg
    this.gameover = edited;
	...
	update: function () {
		...
		if (this.player.score === rounds[this.round]) {
			...
			if (!rounds[this.round + 1]) {
				this.over = true;
        setTimeout(function () { self.setWinner(true); 
